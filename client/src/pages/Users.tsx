...
import {PATREON_CLIENT_ID, PATREON_REDIRECT_URI, PATREON_SCOPE} from '../vars.ts';

const Users: React.FC = () => {
    const [isLinked, setIsLinked] = useState(false);

    const handleLinkUserPatreon = () => {
        // We add state=user here
        window.location.href = `https://www.patreon.com/oauth2/authorize?response_type=code&client_id=${PATREON_CLIENT_ID}&redirect_uri=${PATREON_REDIRECT_URI}&scope=${PATREON_SCOPE}&state=user`;
    };
